...
class CM01_ForgotPasswordVC: UIViewController {
...
extension CM01_ForgotPasswordVC: UITextFieldDelegate {
    func textFieldShouldReturn(_ textField: UITextField) -> Bool {
        // For forgot password, only one field - just dismiss keyboard
